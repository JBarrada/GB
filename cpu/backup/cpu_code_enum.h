enum map {
  ...
  // D0
  RETNC,	POPDE,		JPNCnn,	XX01,
  CALLNCnn,	PUSHDE,	SUBn,		RST10,
  RETC,	RETI,		JPCnn,		XX02,
  CALLCnn,	XX03,		SBCn,		RST18,
  // E0
  LDIOnA,	POPHL,		LDIOCA,	XX04,
  XX05,		PUSHHL,	ANDn,		RST20,
  ADDSPn,	JPHL,		LDmmA,		XX06,
  XX07,		XX08,		XORn,		RST28,
  // F0
  LDAIOn,	POPAF,		LDAIOC,	DI,
  XX09,		PUSHAF,	ORn,		RST30,
  LDHLSPn,	XX0A,		LDAmm,		EI,
  XX0B,		XX0C,		CPn,		RST38
};
...
enum cbmap {
  ...
  SLAr_h,	SLAr_l,	XX0D,		SLAr_a,
  SRAr_b,	SRAr_c,	SRAr_d,	SRAr_e,
  SRAr_h,	SRAr_l,	XX0E,		SRAr_a,
  // CB30
  SWAPr_b,	SWAPr_c,	SWAPr_d,	SWAPr_e,
  SWAPr_h,	SWAPr_l,	XX0F,		SWAPr_a,
  SRLr_b,	SRLr_c,	SRLr_d,	SRLr_e,
  SRLr_h,	SRLr_l,	XX10,		SRLr_a,
  // CB40
